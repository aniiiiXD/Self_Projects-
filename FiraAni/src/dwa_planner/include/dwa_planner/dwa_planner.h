...
public:
     ...
     */
    void odom_callback(const std_msgs::Float64::ConstPtr &msg);
    /**
    ...
    // Callback function for getting angular velocity -- Change to the IMU Data
    //void angular_callback(const sensor_msgs::Imu::ConstPtr &msg);
    void angular_callback(const std_msgs::Float64::ConstPtr &msg);
    ...
    std::pair<geometry_msgs::Twist, std::vector<State> > calc_cmd_vel(void);
    /**
     * @brief
     */
